...
export const Symfoni: React.FC<SymfoniProps> = ({ showLoading = true, autoInit = true, ...props }) => {
  ...
  const getUniswapV2ERC20 = (_provider: providers.Provider, _signer?: Signer) => {
    let instance = _signer
      ? UniswapV2ERC20__factory.connect(ethers.constants.AddressZero, _signer)
      : UniswapV2ERC20__factory.connect(ethers.constants.AddressZero, _provider);
  ...
  const getMyToken2 = (_provider: providers.Provider, _signer?: Signer) => {
    const contractAddress = "0x29C53bB84BC3a519632Fa3566a4aC1c9862E4565";
    const instance = _signer
      ? MyToken2__factory.connect(contractAddress, _signer)
      : MyToken2__factory.connect(contractAddress, _provider);
  ...
  const getMyToken1 = (_provider: providers.Provider, _signer?: Signer) => {
    const contractAddress = "0x4Ae58181c6380FEd3b9C32Ef8f9A015599813246";
    const instance = _signer
      ? MyToken1__factory.connect(contractAddress, _signer)
      : MyToken1__factory.connect(contractAddress, _provider);
  ...
  const getUniswapV2Factory = (_provider: providers.Provider, _signer?: Signer) => {
    const contractAddress = "0xAcBd7374483643cf884d2ea11Ca302B737C8E15b";
    const instance = _signer
      ? UniswapV2Factory__factory.connect(contractAddress, _signer)
      : UniswapV2Factory__factory.connect(contractAddress, _provider);
  ...
  const getUniswapV2Pair = (_provider: providers.Provider, _signer?: Signer) => {
    let instance = _signer
      ? UniswapV2Pair__factory.connect(ethers.constants.AddressZero, _signer)
      : UniswapV2Pair__factory.connect(ethers.constants.AddressZero, _provider);
  ...
  const getUniswapV2Router02 = (_provider: providers.Provider, _signer?: Signer) => {
    const contractAddress = "0xD23a905cF74c5b3bb3F6dcd3eC8fddd7C9763293";
    const instance = _signer
      ? UniswapV2Router02__factory.connect(contractAddress, _signer)
      : UniswapV2Router02__factory.connect(contractAddress, _provider);
  ...
  const getERC20PresetMinterPauser = (_provider: providers.Provider, _signer?: Signer) => {
    let instance = _signer
      ? ERC20PresetMinterPauser__factory.connect(ethers.constants.AddressZero, _signer)
      : ERC20PresetMinterPauser__factory.connect(ethers.constants.AddressZero, _provider);
